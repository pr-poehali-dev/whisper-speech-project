  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-5xl mx-auto">
        ...
        >
          В 1924 году на пустыре у Воробьёвых гор начали строить фабрику грёз. Сегодня Мосфильм — крупнейшая киностудия Европы и живая история советского и российского кино.
        </motion.p>
